...
$query="SELECT username, password FROM student WHERE username='$_POST[username]' AND password='$_POST[password]'";
...
if($num>0){
	...
	/*echo "<form action='student_log.php' method='POST'>
<fieldset>
...
header("Location: http://localhost/quizmaster/student_log_client.php");
